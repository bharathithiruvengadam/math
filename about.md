...
<a href="index" class="btn" style="display: inline-block; padding: 4px 12px; background-color: #157878; color: white; text-decoration: none; border-radius: 2px;">Home</a>  <a href="about" class="btn" style="display: inline-block; padding: 4px 12px; background-color: #157878; color: white; text-decoration: none; border-radius: 2px;">About Me</a> <a href="teaching" class="btn" style="display: inline-block; padding: 4px 12px; background-color: #157878; color: white; text-decoration: none; border-radius: 2px;">Teaching</a>  <a href="research" class="btn" style="display: inline-block; padding: 4px 12px; background-color: #157878; color: white; text-decoration: none; border-radius: 2px;">Research</a>  <a href="event" class="btn" style="display: inline-block; padding: 4px 12px; background-color: #157878; color: white; text-decoration: none; border-radius: 2px;">Events</a>  <a href="activities" class="btn" style="display: inline-block; padding: 4px 12px; background-color: #157878; color: white; text-decoration: none; border-radius: 2px;">Activities</a> <a href="gallery" class="btn" style="display: inline-block; padding: 4px 12px; background-color: #157878; color: white; text-decoration: none; border-radius: 2px;">Gallery</a>
